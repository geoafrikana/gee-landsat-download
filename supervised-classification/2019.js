...
var training_2019 = bare_soil.merge(dense_vegetation).merge(light_vegetation)
                      .merge(water).merge(built_area)

// Export.table.toAsset({
//   collection: training_2019,
//   description: 'training_2019_export',
//   assetId: 'projects/ornate-lead-196416/assets/training_2019'
// });
...
// Add Layers to Map
// ================================
Map.addLayer(img2019, vis, '2019 Composite');
Map.addLayer(img2019.select('NDVI'), {
  min: -0.2,
  max: 0.8,
  palette: [
...
var training = ee.FeatureCollection('projects/ornate-lead-196416/assets/training_2019');


var label = 'Class';
var bands = ['Blue', 'Green', 'Red', 'NIR',
              'SWIR1', 'NDVI', 'MNDWI', 'NDBI']; 
var input = img2019.select(bands);
print(img2019)
